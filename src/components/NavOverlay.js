			...
			<Link className="navbar-brand headerTextNavOverlay" to={`/`}>Kaylin Lapan | Portfolio</Link>
			  ...
			  <div className="collapse navbar-collapse navOverlayButtons" id="navbarNavDropdown">
			    <ul className="navbar-nav">
				  ...
				  <Link className="nav-link textNavOverlay" to={`/web-development`}>Web Development</Link>
			      </li>
			      <li className="nav-item outlineNavOverlay">
				  <Link className="nav-link textNavOverlay" to={`/art-digital-media`}>Art & Digital Media</Link>
			      </li>
			      <li className="nav-item outlineNavOverlay">
				  <Link className="nav-link textNavOverlay" to={`/product-owner-project-management`}>Product Owner & Project Managment</Link>
			      </li>
			    </ul>
			  </div>
			</nav>
